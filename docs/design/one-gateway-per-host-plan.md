...
| 11  | P4.3 desktop Shared HTTP converges onto a daemon service lease                                                                                                                  | opt-in Shared HTTP                          | in progress: private lease (#947) and lightweight proxy; updater/reaper audit remains               |
