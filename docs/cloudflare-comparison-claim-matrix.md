...
| Block on injection                                             | Detection/coming soon                  | Detect + label; **opt-in high-confidence block** + org force                                                             | Ship                 | SOU-345                                              |
| Metrics / Logpush                                              | Yes                                    | In-app Activity + org usage; **opt-in Prometheus `/metrics`**                                                            | Ship                 | SOU-347                                              |
