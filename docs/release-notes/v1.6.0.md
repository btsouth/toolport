...
**Before exposing headless on a network:** read the [production checklist](https://github.com/btsouth/toolport/blob/main/docs/headless.md#production-checklist) in `docs/headless.md`.
...
See [docs/headless.md](https://github.com/btsouth/toolport/blob/main/docs/headless.md) for compose, env-file secrets, and handshake examples.
...
**Desktop:** click **Toolport v1.x.x** in the sidebar footer to check for updates, or
download the installer from [Releases](https://github.com/btsouth/toolport/releases).

**Docker:** `docker pull ghcr.io/btsouth/toolport-gateway:latest` and restart your
container.

**From source:** `git pull`, `npm install`, `npm run build:gateway`, `npm run tauri dev`.

Full changelog: [CHANGELOG.md](https://github.com/btsouth/toolport/blob/main/CHANGELOG.md#160---2026-07-09).
